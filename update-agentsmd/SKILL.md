...
`AGENTS.md` には**決定論的で恒久的な情報だけ**を置きます。時間とともに揺れる情報は別ファイルに逃します。

| 情報 | 置き場所 |
| :--- | :--- |
| コマンド / 制約 / 非自明な Why / 落とし穴 / インシデント | `AGENTS.md` |
| 仕様変更・未解決課題・他人と共有すべきもの | GitHub Issue |
| いま着手中で覚えておきたいこと | `PLAN.md` |
| セッション内の作業リスト | ファイルに書かない（`TodoWrite` と auto-memory の領域） |
