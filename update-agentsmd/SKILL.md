...
作成・更新の際は次の優先順位でルールを適用します:

1. **グローバル AGENTS.md のドクトリン**（`~/.claude/CLAUDE.md` など）: 剪定ルール・分量・構成方針が最優先
2. **[テンプレート](references/template.md)**: セクション構成の基準
3. **このスキルの固有ルール**: 下記4セクションの追加・更新
