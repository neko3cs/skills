...
- **update-planmd**: Writes or resumes PLAN.md — the in-flight work baton across sessions, tools, and machines, recording the chosen approach, the options already rejected, and the next step.
