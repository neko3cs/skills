...
export function renderStatusReport(report) {
  const lines = [
    ...
    "",
    `Session runtime: ${report.sessionRuntime.label}`,
    "Note: agy has no explicit session id, so /agy:rescue --resume continues the most recent agy conversation on this machine, not a specific tracked thread.",
    ""
  ];
